...
function Accreditations() {
  return (
    <div 
      ...
      className=" font-custom bg-white p-4 md:p-16 text-gray-800 flex flex-col justify-center items-center  "
      style={{
  ...
  <h3 className=" text-lg md:text-2xl  mb-4 text-tealLight">
    YOUR TRUSTED SOURCE FOR EDUCATION
  </h3>
  <h1 className=" text-tealDark text-2xl md:text-4xl font-bold mb-8">
...
>
<button className=" bg-white border-2 border-teal-500 text-gray-500 py-2 px-6 md:py-2.5 md:px-10 rounded-full transition duration-300 mt-8 text-md md:text-xl 
