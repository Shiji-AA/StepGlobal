  ...
  <div className="container max-w-5xl mx-auto px-4">
    ...
    <div className="text-white relative">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
        ...
        <div className="group flex items-center bg-indigo-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
          <img className="w-9" src="data:image/svg+xml,%3C?xml version='1.0' encoding='UTF-8'?%3E %3Csvg width='36px' height='30px' viewBox='0 0 36 30' version='1.1' xmlns='http://www.w3.org/2000/svg'%3E %3Ctitle%3EUntitled%3C/title%3E %3Cg id='Page-1' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'%3E %3Crect id='Rectangle' fill='%231389FD' x='15' y='21' width='21' height='7' rx='3.5'%3E%3C/rect%3E %3Ctext id='BETA' font-family='Roboto-Medium, Roboto' font-size='5' font-weight='400' fill='%23FFFFFF'%3E %3Ctspan x='22' y='26'%3EBETA%3C/tspan%3E %3C/text%3E %3Cg id='vue' fill-rule='nonzero'%3E %3Cg id='Group' transform='translate(18.000000, 15.000000) scale(-1, 1) rotate(-180.000000) translate(-18.000000, -15.000000) translate(-0.000000, -0.000000)'%3E %3Cg transform='translate(0.010406, 0.001744)' fill='%2341B883' id='Path'%3E %3Cpolygon points='20.9853249 29.8255814 17.053785 22.9772093 13.1222451 29.8255814 0.0296569468 29.8255814 17.053785 0.170930233 34.0779131 29.8255814'%3E%3C/polygon%3E %3C/g%3E %3Cg transform='translate(6.774271, 11.862209)' fill='%2334495E' id='Path'%3E %3Cpolygon points='14.2214599 17.9651163 10.28992 11.1167442 6.35838003 17.9651163 0.0754431103 17.9651163 10.28992 0.172674419 20.5043968 17.9651163'%3E%3C/polygon%3E %3C/g%3E %3C/g%3E %3C/g%3E %3C/g%3E %3C/svg%3E" alt="" />
          <div>
            <span>BIM</span>
        ...
        <div className="items-center md:flex md:space-x-6">
            <div className="md:w-1/2">
                ...
                <p className="max-w-md mt-4 text-gray-600">
                    Architecture is not just about buildings, it’s about creating spaces that enhance human experience and stand the test of time. It integrates culture, technology, and creativity to shape environments where people live, work, and interact.
                </p>
            ...
            <div className="mt-8 md:mt-0 md:w-1/2">
                <div className="flex items-center justify-center">
                    <div className="max-w-md">
                        <img
                            className="object-cover object-center w-full rounded-md shadow-lg h-[500px]"
                            ...
                            alt="Architectural design in progress"
                        />
                    </div>
                </div>
            </div>
    ...
    <div className="max-w-5xl px-6 py-16 mx-auto">
        <div className="items-center md:flex md:space-x-6">
                ...
                <div className="flex items-center justify-center">
                    <div className="max-w-md">
                        <img
                            ...
                            alt="Architectural team collaborating on a design"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="mt-8 md:mt-0 md:w-1/2">
                ...
                <p className="max-w-md mt-4 text-gray-600">
                    Architecture is more than just constructing buildings; it's about designing environments that improve the quality of life, balance aesthetics with functionality, and stand as a testament to human creativity. It requires skill, knowledge, and collaboration.
                </p>
                <a href="#" className="block mt-8 text-indigo-700 underline">
                    Meet the Architects
                </a>
...
<section className="bg-white">
    <div className="max-w-5xl px-6 py-16 mx-auto">
        <div className="px-8 py-12 bg-gray-800 rounded-md md:px-20 md:flex md:items-center md:justify-between">
            <div>
                <h3 className="text-2xl font-semibold text-white">Innovative Architectural Designs</h3>
                <p className="max-w-md mt-4 text-gray-400">
                    Architecture is a blend of art and science, where form meets function. Our team focuses on creating sustainable and visually striking buildings that serve as both practical spaces and architectural landmarks.
                </p>
            </div>
