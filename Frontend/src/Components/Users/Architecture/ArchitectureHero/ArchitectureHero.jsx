...
<section>
  <div className="bg-gradient-to-br from-indigo-900 to-green-900 h-screen overflow-hidden flex items-center">
    <div className="container max-w-5xl mx-auto flex flex-wrap items-center">
      {/* Left Content */}
      <div className="w-full md:w-1/2">
        <h1 className="mt-12 text-white text-6xl font-bold">
          The fastest,<br /><span className="text-blue-400">on the planet.</span>
        </h1>
        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">
              We didn’t build the usual
            </h2>
            <p className="mb-4">
              We are creators, designers, and engineers. Problem solvers and
              innovators. Small enough to move fast and efficiently, yet large
              enough to achieve the impact you need at the speed you expect.
              Small enough to move fast and efficiently, yet large enough to
              achieve the impact you need at the speed you expect.
            </p>
            <p>
              We are creators, designers, and engineers. Problem solvers and
              innovators. Small enough to move fast and efficiently.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4 mt-8">
            <img
              ...
              alt="Office space showing creative work environment"
            />
            <img
