...
function Footer() {
  ...
  <div className="lg:col-span-2">
    ...
    <p className=" font-normal text-sm md:text-sm mt-6 text-gray-800 leading-relaxed max-w-[500px] sm:max-w-[500px] mx-auto sm:mx-0 text-justify">
  ...
  <div className="grid grid-cols-1 gap-8 lg:col-span-1 sm:grid-cols-2 lg:grid-cols-2">
    <div>
      <h2 className=" mb-4 text-sm font-normal text-gray-900">
        Follow Us
      </h2>
    ...
    <div>
      ...
      <ul className="space-y-3">
        ...
        <span className="font-normal text-gray-800 text-center sm:text-left text-sm block mt-4">
          © 2025{" "}
          <a href="#">
            An{" "}
            <a
