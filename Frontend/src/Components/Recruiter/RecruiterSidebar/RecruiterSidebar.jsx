...
const handleLogout = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-4 w-64 h-screen px-4 py-4 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <div className="flex flex-col gap-4 ">
          <nav>
            ...
            >
              ...
              <span className="mx-4 font-medium">Education</span>
            </a>
            ...
            >
              ...
              <span className="mx-4 font-medium">Experience</span>
            </a>
            ...
            >
              ...
              <span className="mx-4 font-medium">Languages</span>
            </a>
