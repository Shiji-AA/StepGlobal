...
const ChangePasswordRecruiter= () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const response = await axiosInstanceRecruiter.patch("/recruiterchangepassword", {
          oldPassword: values.oldPassword,
          newPassword: values.newPassword,
        });

        if (response.data) {
          dispatch(setRecruiterInfo(response.data.recruiter));
...
export default ChangePasswordRecruiter;
